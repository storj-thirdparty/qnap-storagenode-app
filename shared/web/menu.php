...
<div class="side-nav col-2">
  <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
    ...
    <a class="nav-link" id="v-pills-rclone-tab" href="gateway.php" role="tab" aria-controls="v-pills-rclone" aria-selected="true"><div class="nav-link-icon"></div>Gateway</a>
  </div>
</div>
