...
<head>
  ...
  <link href="resources/css/wizard.css" type="text/css" rel="stylesheet">
	...
	<div id="app">
		<div class="wizard">
			...
			<div v-bind:class="stepClass">
				...
				<img class="back" src="resources/img/icon-wizard-back.svg" alt="Back" v-if="step > 1 && (step !== 7 || identityStep === 1)" v-on:click="step--">
				<img class="back" src="resources/img/icon-wizard-back.svg" alt="Back" v-else-if="identityStep > 1" v-on:click="identityStep--">
					...
					<div class="row justify-content-center text-center">
						<div class="col-sm-10 col-md-8 col-lg-6">
							...
							<div v-if="step === 1" class="mt-5">
								<img src="resources/img/icon-node.svg" class="head" alt="Storj - Storage Node">
							...
							<div v-if="step === 2">
								<div class="head"><img src="resources/img/icon-email.svg" alt="Email Address"/></div>
							...
							<div v-if="step === 3">
								<div class="head"><img src="resources/img/icon-wallet.svg" alt="Wallet Address"/></div>
							...
							<div v-if="step === 4">
								<div class="head"><img src="resources/img/icon-storage.svg" alt="Storage Allocation" /></div>
								...
								<div class="form-group text-left mt-4 mb-4 mw-300">
									...
									<div class="input-group">
										<span class="error-msg storage-error" v-if="!storageValid">Invalid Entry</span>
                                                                                <input class="storage form-control" id="storageAllocation" type="number" min="1" max="100000"  v-model="storage" v-bind:class="{ invalid: !storageValid }" value="<?php if(isset($prop['Allocation'])){if($prop['Allocation'] !="") {echo $prop['Allocation'];}else{echo "10000";}}else{echo "10000";} ?>" aria-describedby="unitGB" required>
							...
							<div v-if="step === 5">
								<div class="head"><img src="resources/img/icon-directory.svg" alt="Storage Directory" /></div>
								...
								<div class="form-group text-left mt-4 mb-4">
									...
									<div class="input-group">
									  ...
									  <div class="input-group-prepend">
											<button class="browse" v-on:click="directoryBrowse = true"><img src="resources/img/wizard/folder.svg" class="browse-svg" alt="Browse Folder"/>Browse</button>
									  </div>
									</div>
								</div>
							...
							<div v-if="step === 6">
								<div class="head"><img src="resources/img/icon-port.svg" alt="External Port Forwarding" /></div>
							...
							<div v-if="step === 7">
								...
								<div class="head"><img src="resources/img/icon-identity.svg" alt="Identity Path" /></div>
									...
									<div class="form-group text-left mt-4 mb-4">
									    ...
									    <div class="input-group-prepend">
												<button class="browse" v-on:click="directoryBrowse = true"><img src="resources/img/wizard/folder.svg" class="browse-svg" alt="Folder Browse"/>Browse</button>
											</div>
									  </div>
									</div>
				          ...
				          <file-browser v-if="directoryBrowse" v-on:selected="setIdentityDirectory"></file-browser>
								...
								<div class="head"><img src="resources/img/icon-identity.svg" alt="Identity"/></div>
